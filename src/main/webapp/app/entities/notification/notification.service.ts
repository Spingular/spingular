...
export class NotificationService {
  ...
  protected convertDateFromClient(notification: INotification): INotification {
    const copy: INotification = Object.assign({}, notification, {
      creationDate: notification.creationDate != null && notification.creationDate.isValid() ? notification.creationDate.toJSON() : null,
      notificationDate:
        notification.notificationDate != null && notification.notificationDate.isValid() ? notification.notificationDate.toJSON() : null
    });
    return copy;
  }
