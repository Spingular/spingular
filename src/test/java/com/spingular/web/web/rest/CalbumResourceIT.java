...
import com.spingular.web.repository.CalbumRepository;
import com.spingular.web.service.CalbumService;
import com.spingular.web.service.dto.CalbumDTO;
import com.spingular.web.service.mapper.CalbumMapper;
...
public class CalbumResourceIT {
    ...
    @Test
    @Transactional
    public void getAllCalbumsByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        calbumRepository.saveAndFlush(calbum);
    ...
    @Test
    @Transactional
    public void getAllCalbumsByTitleIsNotEqualToSomething() throws Exception {
        // Initialize the database
        calbumRepository.saveAndFlush(calbum);
    ...
    public void getAllCalbumsByTitleIsNullOrNotNull() throws Exception {
        ...
        defaultCalbumShouldNotBeFound("title.specified=false");
                ...
                @Test
    @Transactional
    public void getAllCalbumsByTitleContainsSomething() throws Exception {
        // Initialize the database
        calbumRepository.saveAndFlush(calbum);
    ...
    @Test
    @Transactional
    public void getAllCalbumsByTitleNotContainsSomething() throws Exception {
        // Initialize the database
        calbumRepository.saveAndFlush(calbum);
    ...
    public void getAllCalbumsByCommunityIsEqualToSomething() throws Exception {
        ...
        Community community = calbum.getCommunity();
        calbumRepository.saveAndFlush(calbum);
