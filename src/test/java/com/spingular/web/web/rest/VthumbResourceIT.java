...
public class VthumbResourceIT {
    ...
    @Test
    @Transactional
    public void getAllVthumbsByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vthumbRepository.saveAndFlush(vthumb);
    ...
    @Test
    @Transactional
    public void getAllVthumbsByVthumbUpIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vthumbRepository.saveAndFlush(vthumb);
    ...
    @Test
    @Transactional
    public void getAllVthumbsByVthumbDownIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vthumbRepository.saveAndFlush(vthumb);
    ...
    @Test
    @Transactional
    public void getAllVthumbsByAppuserIsEqualToSomething() throws Exception {
        // Get already existing entity
        Appuser appuser = vthumb.getAppuser();
        vthumbRepository.saveAndFlush(vthumb);
