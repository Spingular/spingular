...
import com.spingular.web.repository.NewsletterRepository;
import com.spingular.web.service.NewsletterService;
import com.spingular.web.service.dto.NewsletterDTO;
import com.spingular.web.service.mapper.NewsletterMapper;
...
public class NewsletterResourceIT {
    ...
    @Test
    @Transactional
    public void getAllNewslettersByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        newsletterRepository.saveAndFlush(newsletter);
