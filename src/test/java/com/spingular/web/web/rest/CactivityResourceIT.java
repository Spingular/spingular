...
import com.spingular.web.repository.CactivityRepository;
import com.spingular.web.service.CactivityService;
import com.spingular.web.service.dto.CactivityDTO;
import com.spingular.web.service.mapper.CactivityMapper;
...
public class CactivityResourceIT {
    ...
    @Test
    @Transactional
    public void getAllCactivitiesByActivityNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        cactivityRepository.saveAndFlush(cactivity);
    ...
    public void getAllCactivitiesByActivityNameIsNullOrNotNull() throws Exception {
        ...
        defaultCactivityShouldNotBeFound("activityName.specified=false");
                ...
                @Test
    @Transactional
    public void getAllCactivitiesByActivityNameContainsSomething() throws Exception {
        // Initialize the database
        cactivityRepository.saveAndFlush(cactivity);
    ...
    @Test
    @Transactional
    public void getAllCactivitiesByActivityNameNotContainsSomething() throws Exception {
        // Initialize the database
        cactivityRepository.saveAndFlush(cactivity);
