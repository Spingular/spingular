...
import com.spingular.web.repository.MessageRepository;
import com.spingular.web.service.MessageService;
import com.spingular.web.service.dto.MessageDTO;
import com.spingular.web.service.mapper.MessageMapper;
...
public class MessageResourceIT {
    ...
    @Test
    @Transactional
    public void getAllMessagesByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        messageRepository.saveAndFlush(message);
    ...
    @Test
    @Transactional
    public void getAllMessagesByMessageTextIsNotEqualToSomething() throws Exception {
        // Initialize the database
        messageRepository.saveAndFlush(message);
    ...
    public void getAllMessagesByMessageTextIsNullOrNotNull() throws Exception {
        ...
        defaultMessageShouldNotBeFound("messageText.specified=false");
                ...
                @Test
    @Transactional
    public void getAllMessagesByMessageTextContainsSomething() throws Exception {
        // Initialize the database
        messageRepository.saveAndFlush(message);
    ...
    @Test
    @Transactional
    public void getAllMessagesByMessageTextNotContainsSomething() throws Exception {
        // Initialize the database
        messageRepository.saveAndFlush(message);
    ...
    @Test
    @Transactional
    public void getAllMessagesByIsDeliveredIsNotEqualToSomething() throws Exception {
        // Initialize the database
        messageRepository.saveAndFlush(message);
    ...
    public void getAllMessagesBySenderIsEqualToSomething() throws Exception {
        // Initialize the database
        messageRepository.saveAndFlush(message);
        Appuser sender = AppuserResourceIT.createEntity(em);
        em.persist(sender);
        em.flush();
    ...
    public void getAllMessagesByReceiverIsEqualToSomething() throws Exception {
        // Initialize the database
        messageRepository.saveAndFlush(message);
        Appuser receiver = AppuserResourceIT.createEntity(em);
        em.persist(receiver);
        em.flush();
