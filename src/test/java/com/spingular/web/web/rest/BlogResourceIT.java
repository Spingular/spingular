...
import com.spingular.web.repository.BlogRepository;
import com.spingular.web.service.BlogService;
import com.spingular.web.service.dto.BlogDTO;
import com.spingular.web.service.mapper.BlogMapper;
...
public class BlogResourceIT {
    ...
    @Test
    @Transactional
    public void getAllBlogsByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        blogRepository.saveAndFlush(blog);
    ...
    @Test
    @Transactional
    public void getAllBlogsByAppuserIsEqualToSomething() throws Exception {
        // Get already existing entity
        Appuser appuser = blog.getAppuser();
        blogRepository.saveAndFlush(blog);
