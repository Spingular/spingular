...
public class NotificationResourceIT {
    ...
    @Test
    @Transactional
    public void getAllNotificationsByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    @Test
    @Transactional
    public void getAllNotificationsByNotificationReasonIsNotEqualToSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    @Test
    @Transactional
    public void getAllNotificationsByNotificationTextIsNotEqualToSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    public void getAllNotificationsByNotificationTextIsNullOrNotNull() throws Exception {
        ...
        defaultNotificationShouldNotBeFound("notificationText.specified=false");
                ...
                @Test
    @Transactional
    public void getAllNotificationsByNotificationTextContainsSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    @Test
    @Transactional
    public void getAllNotificationsByNotificationTextNotContainsSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    @Test
    @Transactional
    public void getAllNotificationsByIsDeliveredIsNotEqualToSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    @Test
    @Transactional
    public void getAllNotificationsByAppuserIsEqualToSomething() throws Exception {
        // Get already existing entity
        Appuser appuser = notification.getAppuser();
        notificationRepository.saveAndFlush(notification);
