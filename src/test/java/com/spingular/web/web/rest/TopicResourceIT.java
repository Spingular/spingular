...
import com.spingular.web.repository.TopicRepository;
import com.spingular.web.service.TopicService;
import com.spingular.web.service.dto.TopicDTO;
import com.spingular.web.service.mapper.TopicMapper;
...
public class TopicResourceIT {
    ...
    @Test
    @Transactional
    public void getAllTopicsByTopicNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        topicRepository.saveAndFlush(topic);
    ...
    public void getAllTopicsByTopicNameIsNullOrNotNull() throws Exception {
        ...
        defaultTopicShouldNotBeFound("topicName.specified=false");
                ...
                @Test
    @Transactional
    public void getAllTopicsByTopicNameContainsSomething() throws Exception {
        // Initialize the database
        topicRepository.saveAndFlush(topic);
    ...
    @Test
    @Transactional
    public void getAllTopicsByTopicNameNotContainsSomething() throws Exception {
        // Initialize the database
        topicRepository.saveAndFlush(topic);
