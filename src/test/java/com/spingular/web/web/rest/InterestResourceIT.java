...
public class InterestResourceIT {
    ...
    @Test
    @Transactional
    public void getAllInterestsByInterestNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        interestRepository.saveAndFlush(interest);
    ...
    public void getAllInterestsByInterestNameIsNullOrNotNull() throws Exception {
        ...
        defaultInterestShouldNotBeFound("interestName.specified=false");
                ...
                @Test
    @Transactional
    public void getAllInterestsByInterestNameContainsSomething() throws Exception {
        // Initialize the database
        interestRepository.saveAndFlush(interest);
    ...
    @Test
    @Transactional
    public void getAllInterestsByInterestNameNotContainsSomething() throws Exception {
        // Initialize the database
        interestRepository.saveAndFlush(interest);
    ...
    @Test
    @Transactional
    public void getAllInterestsByAppuserIsEqualToSomething() throws Exception {
        // Initialize the database
        interestRepository.saveAndFlush(interest);
