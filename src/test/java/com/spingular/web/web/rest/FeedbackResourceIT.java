...
import com.spingular.web.repository.FeedbackRepository;
import com.spingular.web.service.FeedbackService;
import com.spingular.web.service.dto.FeedbackDTO;
import com.spingular.web.service.mapper.FeedbackMapper;
...
public class FeedbackResourceIT {
    ...
    @Test
    @Transactional
    public void getAllFeedbacksByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        feedbackRepository.saveAndFlush(feedback);
    ...
    @Test
    @Transactional
    public void getAllFeedbacksByNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        feedbackRepository.saveAndFlush(feedback);
    ...
    public void getAllFeedbacksByNameIsNullOrNotNull() throws Exception {
        ...
        defaultFeedbackShouldNotBeFound("name.specified=false");
                ...
                @Test
    @Transactional
    public void getAllFeedbacksByNameContainsSomething() throws Exception {
        // Initialize the database
        feedbackRepository.saveAndFlush(feedback);
    ...
    @Test
    @Transactional
    public void getAllFeedbacksByNameNotContainsSomething() throws Exception {
        // Initialize the database
        feedbackRepository.saveAndFlush(feedback);
    ...
    @Test
    @Transactional
    public void getAllFeedbacksByEmailIsNotEqualToSomething() throws Exception {
        // Initialize the database
        feedbackRepository.saveAndFlush(feedback);
    ...
    public void getAllFeedbacksByEmailIsNullOrNotNull() throws Exception {
        ...
        defaultFeedbackShouldNotBeFound("email.specified=false");
                ...
                @Test
    @Transactional
    public void getAllFeedbacksByEmailContainsSomething() throws Exception {
        // Initialize the database
        feedbackRepository.saveAndFlush(feedback);
    ...
    @Test
    @Transactional
    public void getAllFeedbacksByEmailNotContainsSomething() throws Exception {
        // Initialize the database
        feedbackRepository.saveAndFlush(feedback);
    ...
    @Test
    @Transactional
    public void getAllFeedbacksByFeedbackIsNotEqualToSomething() throws Exception {
        // Initialize the database
        feedbackRepository.saveAndFlush(feedback);
    ...
    public void getAllFeedbacksByFeedbackIsNullOrNotNull() throws Exception {
        ...
        defaultFeedbackShouldNotBeFound("feedback.specified=false");
                ...
                @Test
    @Transactional
    public void getAllFeedbacksByFeedbackContainsSomething() throws Exception {
        // Initialize the database
        feedbackRepository.saveAndFlush(feedback);
    ...
    @Test
    @Transactional
    public void getAllFeedbacksByFeedbackNotContainsSomething() throws Exception {
        // Initialize the database
        feedbackRepository.saveAndFlush(feedback);
