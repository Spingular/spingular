...
import com.spingular.web.repository.CinterestRepository;
import com.spingular.web.service.CinterestService;
import com.spingular.web.service.dto.CinterestDTO;
import com.spingular.web.service.mapper.CinterestMapper;
...
public class CinterestResourceIT {
    ...
    @Test
    @Transactional
    public void getAllCinterestsByInterestNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        cinterestRepository.saveAndFlush(cinterest);
    ...
    public void getAllCinterestsByInterestNameIsNullOrNotNull() throws Exception {
        ...
        defaultCinterestShouldNotBeFound("interestName.specified=false");
                ...
                @Test
    @Transactional
    public void getAllCinterestsByInterestNameContainsSomething() throws Exception {
        // Initialize the database
        cinterestRepository.saveAndFlush(cinterest);
    ...
    @Test
    @Transactional
    public void getAllCinterestsByInterestNameNotContainsSomething() throws Exception {
        // Initialize the database
        cinterestRepository.saveAndFlush(cinterest);
