...
import com.spingular.web.repository.CmessageRepository;
import com.spingular.web.service.CmessageService;
import com.spingular.web.service.dto.CmessageDTO;
import com.spingular.web.service.mapper.CmessageMapper;
...
public class CmessageResourceIT {
    ...
    @Test
    @Transactional
    public void getAllCmessagesByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        cmessageRepository.saveAndFlush(cmessage);

        // Get all the cmessageList where creationDate not equals to DEFAULT_CREATION_DATE
        defaultCmessageShouldNotBeFound("creationDate.notEquals=" + DEFAULT_CREATION_DATE);

        // Get all the cmessageList where creationDate not equals to UPDATED_CREATION_DATE
        defaultCmessageShouldBeFound("creationDate.notEquals=" + UPDATED_CREATION_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllCmessagesByMessageTextIsNotEqualToSomething() throws Exception {
        // Initialize the database
        cmessageRepository.saveAndFlush(cmessage);

        // Get all the cmessageList where messageText not equals to DEFAULT_MESSAGE_TEXT
        defaultCmessageShouldNotBeFound("messageText.notEquals=" + DEFAULT_MESSAGE_TEXT);

        // Get all the cmessageList where messageText not equals to UPDATED_MESSAGE_TEXT
        defaultCmessageShouldBeFound("messageText.notEquals=" + UPDATED_MESSAGE_TEXT);
    }
    ...
    public void getAllCmessagesByMessageTextIsNullOrNotNull() throws Exception {
        ...
        defaultCmessageShouldNotBeFound("messageText.specified=false");
                ...
                @Test
    @Transactional
    public void getAllCmessagesByMessageTextContainsSomething() throws Exception {
        // Initialize the database
        cmessageRepository.saveAndFlush(cmessage);

        // Get all the cmessageList where messageText contains DEFAULT_MESSAGE_TEXT
        defaultCmessageShouldBeFound("messageText.contains=" + DEFAULT_MESSAGE_TEXT);

        // Get all the cmessageList where messageText contains UPDATED_MESSAGE_TEXT
        defaultCmessageShouldNotBeFound("messageText.contains=" + UPDATED_MESSAGE_TEXT);
    }

    @Test
    @Transactional
    public void getAllCmessagesByMessageTextNotContainsSomething() throws Exception {
        // Initialize the database
        cmessageRepository.saveAndFlush(cmessage);

        // Get all the cmessageList where messageText does not contain DEFAULT_MESSAGE_TEXT
        defaultCmessageShouldNotBeFound("messageText.doesNotContain=" + DEFAULT_MESSAGE_TEXT);

        // Get all the cmessageList where messageText does not contain UPDATED_MESSAGE_TEXT
        defaultCmessageShouldBeFound("messageText.doesNotContain=" + UPDATED_MESSAGE_TEXT);
    }
    ...
    @Test
    @Transactional
    public void getAllCmessagesByIsDeliveredIsNotEqualToSomething() throws Exception {
        // Initialize the database
        cmessageRepository.saveAndFlush(cmessage);

        // Get all the cmessageList where isDelivered not equals to DEFAULT_IS_DELIVERED
        defaultCmessageShouldNotBeFound("isDelivered.notEquals=" + DEFAULT_IS_DELIVERED);

        // Get all the cmessageList where isDelivered not equals to UPDATED_IS_DELIVERED
        defaultCmessageShouldBeFound("isDelivered.notEquals=" + UPDATED_IS_DELIVERED);
    }
    ...
    public void getAllCmessagesByCsenderIsEqualToSomething() throws Exception {
        // Initialize the database
        cmessageRepository.saveAndFlush(cmessage);
        Community csender = CommunityResourceIT.createEntity(em);
        em.persist(csender);
        em.flush();
    ...
    public void getAllCmessagesByCreceiverIsEqualToSomething() throws Exception {
        // Initialize the database
        cmessageRepository.saveAndFlush(cmessage);
        Community creceiver = CommunityResourceIT.createEntity(em);
