...
import com.spingular.web.service.TagService;
...
import com.spingular.web.service.TagQueryService;
...
public class TagResourceIT {
    ...
    @Test
    @Transactional
    public void getAllTagsByTagNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        tagRepository.saveAndFlush(tag);
    ...
    public void getAllTagsByTagNameIsNullOrNotNull() throws Exception {
        ...
        defaultTagShouldNotBeFound("tagName.specified=false");
                ...
                @Test
    @Transactional
    public void getAllTagsByTagNameContainsSomething() throws Exception {
        // Initialize the database
        tagRepository.saveAndFlush(tag);
    ...
    @Test
    @Transactional
    public void getAllTagsByTagNameNotContainsSomething() throws Exception {
        // Initialize the database
        tagRepository.saveAndFlush(tag);
