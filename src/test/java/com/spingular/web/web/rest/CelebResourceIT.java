...
public class CelebResourceIT {
    ...
    @Test
    @Transactional
    public void getAllCelebsByCelebNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        celebRepository.saveAndFlush(celeb);
    ...
    public void getAllCelebsByCelebNameIsNullOrNotNull() throws Exception {
        ...
        defaultCelebShouldNotBeFound("celebName.specified=false");
                ...
                @Test
    @Transactional
    public void getAllCelebsByCelebNameContainsSomething() throws Exception {
        // Initialize the database
        celebRepository.saveAndFlush(celeb);
    ...
    @Test
    @Transactional
    public void getAllCelebsByCelebNameNotContainsSomething() throws Exception {
        // Initialize the database
        celebRepository.saveAndFlush(celeb);
    ...
    @Test
    @Transactional
    public void getAllCelebsByAppuserIsEqualToSomething() throws Exception {
        // Initialize the database
        celebRepository.saveAndFlush(celeb);
