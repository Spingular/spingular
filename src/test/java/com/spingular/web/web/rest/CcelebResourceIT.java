...
import com.spingular.web.repository.CcelebRepository;
import com.spingular.web.service.CcelebService;
import com.spingular.web.service.dto.CcelebDTO;
import com.spingular.web.service.mapper.CcelebMapper;
...
public class CcelebResourceIT {
    ...
    @Test
    @Transactional
    public void getAllCcelebsByCelebNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        ccelebRepository.saveAndFlush(cceleb);
    ...
    public void getAllCcelebsByCelebNameIsNullOrNotNull() throws Exception {
        ...
        defaultCcelebShouldNotBeFound("celebName.specified=false");
                ...
                @Test
    @Transactional
    public void getAllCcelebsByCelebNameContainsSomething() throws Exception {
        // Initialize the database
        ccelebRepository.saveAndFlush(cceleb);
    ...
    @Test
    @Transactional
    public void getAllCcelebsByCelebNameNotContainsSomething() throws Exception {
        // Initialize the database
        ccelebRepository.saveAndFlush(cceleb);
