...
import { AppprofileComponent } from 'app/entities/appprofile/appprofile.component';
...
describe('Component Tests', () => {
  describe('Appprofile Management Component', () => {
    let comp: AppprofileComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AppprofileComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.appprofiles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
