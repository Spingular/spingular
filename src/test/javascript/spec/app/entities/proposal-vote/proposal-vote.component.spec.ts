...
import { ProposalVoteComponent } from 'app/entities/proposal-vote/proposal-vote.component';
...
describe('Component Tests', () => {
  describe('ProposalVote Management Component', () => {
    let comp: ProposalVoteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProposalVoteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.proposalVotes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
