...
import { AppphotoComponent } from 'app/entities/appphoto/appphoto.component';
...
describe('Component Tests', () => {
  describe('Appphoto Management Component', () => {
    let comp: AppphotoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AppphotoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.appphotos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
